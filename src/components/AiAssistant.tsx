...
export const AiAssistant: React.FC = () => {
  ...
  const quickQuestions = [
    { label: "学术文献如何合规免费查阅？", q: "如何不用学校账号，合规、免费地查阅并下载知网与万方学术论文？" },
