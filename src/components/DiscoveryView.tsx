          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {relatedGaps.map((gap) => (
              <button
                ...
                className="opportunity-card bg-white rounded-2xl border border-gray-100 p-6 text-left hover:border-primary/25 transition-all"
              >
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  <span className="text-xs font-bold text-gray-500">{gap.region}</span>
                </div>
